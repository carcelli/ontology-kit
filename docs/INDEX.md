...
1. **[Semantic Leverage Guide](SEMANTIC_LEVERAGE_GUIDE.md)** ← **START HERE**
   - How to read 3D t-SNE maps
   - Understanding leverage scores
   - Complete operational workflow
   - Real-world business examples

2. **[Technical Reference](README_SEMANTIC_TOOLS.md)**
...
- **[Semantic Leverage Guide](SEMANTIC_LEVERAGE_GUIDE.md)** (100+ pages)
...
- **[README: Semantic Tools](README_SEMANTIC_TOOLS.md)** (Technical Reference)
...
- **[Semantic Graph Implementation](../SEMANTIC_GRAPH_IMPLEMENTATION.md)**
  - What was delivered
  - Code statistics
  - File manifest
  - Testing results
...
**More**: See [README_SEMANTIC_TOOLS.md](README_SEMANTIC_TOOLS.md#troubleshooting)
...
1. [Semantic Leverage Guide](SEMANTIC_LEVERAGE_GUIDE.md) — Start here
2. [Technical Reference](README_SEMANTIC_TOOLS.md) — API docs
3. Run demos
...
1. [Semantic Leverage Guide](SEMANTIC_LEVERAGE_GUIDE.md) — Theory
2. [Implementation Details](../SEMANTIC_GRAPH_IMPLEMENTATION.md) — Code
3. [ML Tool Ontology](../ML_TOOL_ONTOLOGY.md) — Architecture
4. Extend with causal inference, multi-objective optimization

### For Agent Builders

1. [Technical Reference](README_SEMANTIC_TOOLS.md) — API
2. [ML Tool Ontology](../ML_TOOL_ONTOLOGY.md) — Discovery pattern
3. [Integration Guide](../LEVERAGE_TOOL_INTEGRATION.md) — OpenAI SDK
...
├── SEMANTIC_LEVERAGE_GUIDE.md            ← Theory + practice (START HERE)
├── README_SEMANTIC_TOOLS.md              ← Technical reference
├── LEVERAGE_ANALYSIS_TOOL.md             ← Existing tool docs
└── HYPERDIM_VIZ_TOOL.md                  ← Basic visualization

Root/
├── ML_TOOL_ONTOLOGY.md                   ← Architecture
├── LEVERAGE_TOOL_INTEGRATION.md          ← Integration details
└── SEMANTIC_GRAPH_IMPLEMENTATION.md      ← What was delivered
```
...
**Questions?**
- Theory: See [Semantic Leverage Guide](SEMANTIC_LEVERAGE_GUIDE.md)
- Technical: See [README_SEMANTIC_TOOLS.md](README_SEMANTIC_TOOLS.md)
